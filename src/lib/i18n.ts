...
export const dictionaries = {
  en: {
    ...
    org: {
      ...
      sectionOngoing: "Current Events",
      sectionEnded: "Past Events",
    },
    event: {
      ...
      errorInvalidInput: "Please check the event details.",
      errorInvalidRecurrence: "Please check the recurrence settings.",
      errorInvalidDate: "Event date is invalid.",
      errorInvalidTime: "Check-in time is invalid.",
      errorStartInFuture: "Check-in start must be in the future.",
      errorEndAfterStart: "Check-in end must be after the start.",
      errorNoEvents: "No events were generated from the recurrence settings.",
      errorCreateFailed: "Failed to create the event. Please try again.",
      myStatus: "My status",
      ...
      repeatLabel: "Create recurring events",
  ...
  ko: {
    ...
    reset: {
      title: "비밀번호 재설정",
      subtitle: "이메일로 코드를 받아 새 비밀번호를 설정하세요.",
      sendButton: "재설정 코드 보내기",
      sending: "발송 중...",
      sent: "이메일이 존재한다면 재설정 코드가 발송되었습니다.",
      codeLabel: "재설정 코드",
      newPasswordLabel: "새 비밀번호",
      verifyButton: "비밀번호 변경",
      verifying: "변경 중...",
    ...
    org: {
      ...
      statusOngoing: "진행 중",
      statusEnded: "종료",
      sectionUpcoming: "예정된 일정",
      sectionOngoing: "현재 일정",
      sectionEnded: "지나간 일정",
    },
    event: {
      createTitle: "일정 생성",
      ...
      errorInvalidInput: "일정 정보를 다시 확인해주세요.",
      errorInvalidRecurrence: "반복 설정을 다시 확인해주세요.",
      errorInvalidDate: "일정 날짜가 올바르지 않습니다.",
      errorInvalidTime: "출석 시간이 올바르지 않습니다.",
      errorStartInFuture: "출석 시작 시간은 현재 이후여야 합니다.",
      errorEndAfterStart: "출석 종료 시간은 시작 이후여야 합니다.",
      errorNoEvents: "반복 일정이 생성되지 않았습니다.",
      errorCreateFailed: "일정 생성에 실패했습니다. 다시 시도해주세요.",
      myStatus: "내 출석 상태",
      checkedAt: "체크인 시각",
      checkIn: "출석 체크",
      checkingIn: "위치 확인 중...",
      ...
      repeatLabel: "반복 일정 생성",
      repeatWeeks: "기간(주)",
      repeatWeekdays: "요일 선택",
      repeatPreview: "생성 미리보기",
      weekdayMon: "월",
      weekdayTue: "화",
      weekdayWed: "수",
      weekdayThu: "목",
